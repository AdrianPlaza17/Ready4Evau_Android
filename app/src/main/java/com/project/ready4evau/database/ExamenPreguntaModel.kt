...
class ExamenModel(val id_Examen : Int, var pregunta1: String, var pregunta2: String, var pregunta3: String, var pregunta4: String,
                  ...
                  val asignatura: String, val tema: String, var nota: String, var fecha: String): Serializable

class ExamenAdapterModel(val id_Examen : Int, val asignatura: String, val tema: String, var nota: String, var fecha: String): Serializable
